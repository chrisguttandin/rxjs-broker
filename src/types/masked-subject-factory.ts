...
export type TMaskedSubjectFactory = <
    T extends TStringifyableJsonValue,
    U extends TStringifyableJsonObject & { message: T } = TStringifyableJsonObject & { message: T },
    V extends TStringifyableJsonObject | U = TStringifyableJsonObject | U
